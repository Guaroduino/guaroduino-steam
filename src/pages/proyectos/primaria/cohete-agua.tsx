      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-b border-gray-200 mb-8">
          <nav className="-mb-px flex space-x-8">
            {['descripcion', 'materiales', 'instrucciones', 'seguridad', 'recursos'].map((tab) => (
              <button
                key={tab}
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      <Link href="/recursos/cohete-agua/registro.html" className="text-blue-600 hover:text-blue-800 flex items-center">
                        ...
                        Hoja de registro de lanzamientos
                      </Link>
                    </li>
                    <li>
                  ...
                  <ul className="space-y-3">
                    <li>
                      <a href="#" className="text-blue-600 hover:text-blue-800 flex items-center">
                        ...
                        Video tutorial de construcción
                      </a>
                    </li>
                    <li>
                      <a href="#" className="text-blue-600 hover:text-blue-800 flex items-center">
